...
if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
        e.preventDefault();
        alert('شكراً لرسالتك! سنرد عليك في أقرب وقت.');
        contactForm.reset();
    });
}
...
galleryItems.forEach(item => {
    item.addEventListener('click', () => {
        alert('تم النقر على صورة المعرض! يمكنك إضافة ميزة lightbox هنا.');
    });
});

console.log('المدرسة الخاصة زرمانية - تم تحميل الموقع بنجاح!');
